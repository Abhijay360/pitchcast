...
**PitchCast** — Premier League Season Simulation Engine

## One-line headline

Built PitchCast, an end-to-end Premier League prediction engine with Dixon-Coles Poisson modelling, Monte Carlo simulation, and a live FastAPI dashboard.

---

## Short description (≈300 characters — Projects section)

Developed PitchCast, a full-stack football analytics system that predicts the 2026–27 Premier League season. Ingests 10 years of match data and Transfermarkt squad values, runs a custom Dixon-Coles + Monte Carlo simulator (5,000 iterations), and serves projections through a FastAPI web dashboard with fixture-level probabilities, goalscorer odds, and league tables.

---

## Full post (copy-paste for LinkedIn feed)

🏆 **I built PitchCast — a Premier League season predictor from scratch — and it's live.**
...
• Anytime / first goalscorer probs from squad shot & scoring data
...
• Match detail pages with squad sheets, insights, and likely scorers
...
🔗 GitHub: https://github.com/Abhijay360/pitchcast

#Python #DataScience #SportsAnalytics #MachineLearning #Football #PremierLeague #FastAPI #MonteCarlo #OpenSource #PitchCast
...
- Integrated **Transfermarkt** squad data (market values, net spend, player rosters, shot volumes) for projections and goalscorer odds
- Delivered **PitchCast**, a FastAPI dashboard with fixture predictions, projected standings, match insights, and player/team profiles
...
⚽ PitchCast — Premier League season predictor: Dixon-Coles Poisson + Monte Carlo, Transfermarkt squad data, goalscorer probs, 10-year backtesting, FastAPI dashboard.

**Topics:** `python` `football` `premier-league` `sports-analytics` `monte-carlo` `poisson` `fastapi` `data-science` `simulation` `pitchcast`
